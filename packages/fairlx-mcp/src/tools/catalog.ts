...
export const TOOL_CATALOG: McpToolDefinition[] = [
  ...
  // ── GitHub Repos ──
  {
    ...
    description:
      "List Fairlx-attached GitHub repositories for a project AND repositories from the acting user's connected GitHub account. An empty Fairlx attachment list does not mean GitHub is disconnected. Pass query to filter GitHub.com repos by name (e.g. Fairlx).",
    inputSchema: {
      type: "object",
      properties: {
        projectId: id,
        query: { type: "string", description: "Optional name filter for the user's GitHub.com repositories." },
        limit: { type: "number" },
      },
      required: ["projectId"],
    },
  ...
  {
    name: "fairlx_github_repo_create",
    description:
      "Create a GitHub.com repository as this user. Defaults to private. Pass owner for an organization. Do not say this action is unavailable.",
    inputSchema: {
      type: "object",
      properties: {
        name: { type: "string" },
  ...
  {
    name: "fairlx_github_repo_update",
    description:
      "Update a GitHub repository: visibility (private/public), description, or homepage. Use when asked to make a repo private.",
    inputSchema: {
      type: "object",
      properties: {
        projectId: id,
  ...
  {
    name: "fairlx_github_file_write",
    description: "Create or update a GitHub file. Returns html_url for the blob.",
    inputSchema: {
      type: "object",
      properties: {
        projectId: id,
  ...
  {
    name: "fairlx_github_file_delete",
  ...
  {
    name: "fairlx_github_issue_create",
  ...
  {
    name: "fairlx_github_issue_comment",
  ...
  {
    name: "fairlx_github_issue_close",
  ...
  {
    name: "fairlx_github_branch_list",
    description: "List branches in a GitHub repository.",
    inputSchema: {
      type: "object",
      properties: { projectId: id, owner: { type: "string" }, repo: { type: "string" }, repoId: { type: "string" } },
    },
    riskTier: 1,
    rateClass: "read",
    scopes: ["project:read"],
