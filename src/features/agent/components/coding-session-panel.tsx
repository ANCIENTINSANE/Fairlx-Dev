  ...
  return (
    <div className="flex flex-col">
      <div className="mb-1.5 flex items-center justify-between gap-2 px-1">
        <div className="text-[11px] tracking-wider uppercase font-semibold text-sidebar-foreground/50">
          Coding session
        </div>
        <span className="text-[10px] font-medium capitalize text-sidebar-foreground/50">
          {phase}
