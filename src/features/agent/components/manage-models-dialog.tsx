      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            {hasGrok
              ? "Auto routes between Grok 4.6 and DeepSeek V4 Flash. GPT-5.6 Luna and DeepSeek V4 Pro are selectable in Manual. Add BYOK providers from the catalog."
              : "Auto uses DeepSeek V4 Flash. GPT-5.6 Luna and DeepSeek V4 Pro are selectable in Manual. Add BYOK providers from the catalog."}
          </DialogDescription>
        </DialogHeader>
